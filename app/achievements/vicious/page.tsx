...
import { viciousAchievements } from '@/data/achievements';
import { useLanguage } from '@/contexts/LanguageContext';
import { en } from '@/data/translations/en';
import { ar } from '@/data/translations/ar';

export default function ViciousAchievementsPage() {
      ...
      <div className="container">
        ...
        <div style={{ marginBottom: '3rem' }}>
          <span
            ...
            style={{ color: '#4f75ff', display: 'block', marginBottom: '0.75rem' }}
          >
            {v.sectionLabel}
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {viciousAchievements.map((achievement) => (
            <div
              key={achievement.id}
            ...
            >
              {achievement.images.length > 0 ? (
                ...
                <div
                  style={{
                    aspectRatio: '16/9',
                    background: 'linear-gradient(135deg, rgba(79,117,255,0.15), rgba(123,92,246,0.15))',
                    display: 'flex',
                    alignItems: 'center',
